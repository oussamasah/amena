 ...
 */
final class Version20230801121205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, expeditor_id INT DEFAULT NULL, price INT NOT NULL, tax INT NOT NULL, create_at DATETIME NOT NULL, state VARCHAR(255) NOT NULL, closed_at DATETIME DEFAULT NULL, INDEX IDX_FE866410F61053BB (expeditor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, message VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, seen TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, seen_at DATETIME DEFAULT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_BF5476CAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE package (id INT AUTO_INCREMENT NOT NULL, expeditor_id INT NOT NULL, region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, delivery_id INT DEFAULT NULL, facture_id INT DEFAULT NULL, label VARCHAR(255) NOT NULL, price INT NOT NULL, dest_name VARCHAR(255) NOT NULL, dest_phone INT NOT NULL, nb_product INT NOT NULL, state VARCHAR(255) NOT NULL, create_date DATE NOT NULL, adress VARCHAR(255) NOT NULL, validated_at DATETIME DEFAULT NULL, picked_at DATETIME DEFAULT NULL, pending_at DATETIME DEFAULT NULL, processing_at DATETIME DEFAULT NULL, closed_at DATETIME DEFAULT NULL, INDEX IDX_DE686795F61053BB (expeditor_id), INDEX IDX_DE68679598260155 (region_id), INDEX IDX_DE6867958BAC62AF (city_id), INDEX IDX_DE68679512136921 (delivery_id), INDEX IDX_DE6867957F2DEE08 (facture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, region_id INT DEFAULT NULL, city_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, identity VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, frais_de_livraison INT DEFAULT NULL, frais_de_retour INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6499B6B5FBA (account_id), INDEX IDX_8D93D64998260155 (region_id), INDEX IDX_8D93D6498BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE facture ADD CONSTRAINT FK_FE866410F61053BB FOREIGN KEY (expeditor_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE package ADD CONSTRAINT FK_DE6867957F2DEE08 FOREIGN KEY (facture_id) REFERENCES facture (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP FOREIGN KEY FK_FE866410F61053BB');
        ...
        $this->addSql('ALTER TABLE package DROP FOREIGN KEY FK_DE6867957F2DEE08');
